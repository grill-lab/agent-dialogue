...
public class DialogManager {
    ...
    public void initialiseDialogflowDialogManagerInstanceAndLogger(String languageCode, String logFileLocation, String sessionId, Map<String, String> agentsByProjectIdAndKeyMap) throws Exception {
        _dialogflowDialogManagerInstance = new DialogflowDialogManager(languageCode, sessionId, agentsByProjectIdAndKeyMap);
